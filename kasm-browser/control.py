#!/usr/bin/env python3
# Single-session control for the KasmVNC isolated browser (B1). Launches/relaunches
# a kiosk Chromium on DISPLAY :1. Internal-only. Concurrency is a later slice.
