...
export default async function EditSitePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [site, connectors] = await Promise.all([
    db.site.findUnique({
      where: { id },
      select: { id: true, connectorId: true, name: true, hostname: true, upstreamUrl: true, description: true, insecureSkipVerify: true, recordSessions: true, clipboardMode: true, watermark: true, accessMode: true, logoType: true },
    }),
